    ...
    <form onSubmit={onSubmitHandler} className='min-h-[80vh]' flex items-center>
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border'>
        ...
        <div className='w-full'>
          <p>Email</p>
          <input className='border border-zinc-300 rounded w-full py-2 mt-1' type="text" />
        </div>
        <div className='w-full'>
          <p>Password</p>
          <input className='border border-zinc-300 rounded w-full py-2 mt-1' type="password" />
        </div>
